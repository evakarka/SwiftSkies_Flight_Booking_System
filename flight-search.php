...
$sql = "SELECT * FROM addflights"; // Αντικαταστήστε flights με το όνομα της πίνακα σας
...
<div class="container">
    ...
    <?php
    // Κώδικας PHP για τη σύνδεση με τη βάση δεδομένων και την ανάκτηση των πτήσεων
    // Επίσης, προστέθηκαν τα κρυφά πεδία για τα δεδομένα της πτήσης
